...
#define DEVID	"35136498"

#define APIKEY	"aA0N72uEAXV=Z9EbxKBfFXZxsQY="
...
unsigned char OneNet_FillBuf(char *buf)
{
	...
	memset(text, 0, sizeof(text));
	sprintf(text, "\"humidity\":%d", humidity); //最后一项不需要逗号！！
	strcat(buf, text);
